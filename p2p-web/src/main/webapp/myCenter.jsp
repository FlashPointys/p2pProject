                 ...
                 <dl>
                     ...
                     <c:forEach items="${bidInfoList}" var="bidInfo" varStatus="index">
                         <dd>
                             ...
                             <span id="preparedLoanTotalIncome" class="profit"><fmt:formatDate value="${bidInfo.bidTime}" pattern="yyyy-MM-dd HH:mm:ss"></fmt:formatDate> </span>
                         </dd>
                     </c:forEach>
                     	<%--<dd>
                ...
                <dl id="recentearning">
                    ...
                    <c:forEach items="${incomeRecordList}" var="incomeRecord" varStatus="index">
                        <dd>
                            ...
                            <span id="preparedLoanStandardTotalIncome" class="number name" style="text-align:center;"><fmt:formatDate value="${incomeRecord.incomeDate}" pattern="yyyy-MM-dd HH:mm:ss"></fmt:formatDate> </span>
